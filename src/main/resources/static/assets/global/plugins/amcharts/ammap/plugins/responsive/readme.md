...
Or you can omit the "id" and just apply overrides in the same sortField as you have
them defined. I.e.:
...
current chart condition and will apply their overrides in the same sortField they
are defined.
...
### 0.9.2
* Fixed a custom rules being applied in the wrong sortField
