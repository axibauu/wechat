...
These buttons could also be part of an unordered list, with the data attribute to sort by entered as the "data-sort" attribute, and the sortField to sort by entered as the "data-sortField" attribute:

	<ul>
	    <li class="sort" data-sort="data-name" data-sortField="desc"></li>
	    <li class="sort" data-sort="data-name" data-sortField="asc"></li>
	    <li class="sort" data-sort="data-age" data-sortField="desc"></li>
	    <li class="sort" data-sort="data-age" data-sortField="asc"></li>
	    <li class="sort" data-sort="default" data-sortField="asc"></li>
	    <li class="sort" data-sort="random"></li>
	</ul>

Sorting by 'default' maintains the sortField that elements are originally entered into the DOM, and is useful for toggling between descending and ascending sortField, without sorting by a specific attribute.
